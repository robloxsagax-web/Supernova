"""
Script Generation API using Genblaze

This route handles script generation for video ads using the Genblaze library
with OpenAI-compatible provider through OpenRouter.
"""
...
def handler(request: Any) -> dict:
    ...
    Compatible with Next.js Python runtime.
    """
