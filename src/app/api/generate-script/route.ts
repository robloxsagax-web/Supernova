...
export async function POST(request: Request) {
  try {
    ...
    // Initialize OpenAI client with OpenRouter base URL (using Genblaze-compatible provider)
    ...
    // Generate script using OpenRouter Qwen model (via Genblaze-compatible OpenAI SDK)
