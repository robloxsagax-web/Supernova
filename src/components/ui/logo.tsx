...
import { SupernovaLogo as SharedLogo } from '@/components/branding';
...
/**
 * Logo for Dashboard - Uses shared official Supernova logo
 */
export function DashboardLogo({ className = '' }: { className?: string }) {
  return (
    <SharedLogo size={44} className={className} />
  );
}
...
export function LogoIcon({ 
  ...
  return (
    <motion.div 
      ...
      transition={{ type: 'spring', stiffness: 400, damping: 25 }}
    >
      <SharedLogo size={iconSizes[size]} className={className} />
