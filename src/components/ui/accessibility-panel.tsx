        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              borderLeft: '1px solid rgba(255, 218, 185, 0.15)',
              boxShadow: '-20px 0 60px rgba(0, 0, 0, 0.5), inset 1px 0 0 rgba(255, 218, 185, 0.05)',
            }}
          >
            {/* Ambient top glow */}
            <div className="absolute top-0 left-0 right-0 h-40 pointer-events-none" style={{
              background: 'radial-gradient(ellipse at 50% 0%, rgba(92, 51, 23, 0.2) 0%, transparent 70%)',
            }} />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{
                    ...
                    boxShadow: '0 4px 20px rgba(92, 51, 23, 0.5), inset 0 1px 0 rgba(255, 218, 185, 0.2)',
                  }}>
                    <Accessibility className="w-6 h-6 text-[#FFDAB9]" />
                  </div>
                  <div>
                    <h2 className="text-2xl font-bold text-white">Accessibility</h2>
                    <p className="text-sm text-[rgba(255,255,255,0.6)]">Customize your experience</p>
                  </div>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="space-y-3 p-4 rounded-2xl glass-panel">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{
                    background: 'linear-gradient(135deg, rgba(92,51,23,0.4) 0%, rgba(139,90,43,0.3) 100%)',
                    boxShadow: 'inset 0 1px 0 rgba(255, 218, 185, 0.1)',
                  }}>
                    <Sun className="w-5 h-5 text-[#FFDAB9]" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-white">High Contrast Mode</h3>
                    <p className="text-sm text-[rgba(255,255,255,0.6)]">Increase visibility with higher contrast</p>
                  </div>
                </div>
                <Toggle
              ...
              <div className="space-y-3 p-4 rounded-2xl glass-panel">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[rgba(255,255,255,0.6)]">Adjust text size for better readability</p>
                  </div>
                </div>
              ...
              <div className="space-y-3 p-4 rounded-2xl glass-panel">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[rgba(255,255,255,0.6)]">Minimize animations and transitions</p>
                  </div>
                </div>
                <Toggle
              ...
              <div className="space-y-3 p-4 rounded-2xl glass-panel">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[rgba(255,255,255,0.6)]">Optimize colors for better visibility</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <div className="flex-1 space-y-2">
                    <motion.div 
                      ...
                      style={{ 
                        background: '#5C3317',
                        boxShadow: '0 4px 20px rgba(92, 51, 23, 0.4), inset 0 1px 0 rgba(255, 218, 185, 0.2)',
                      }}
                    >
                    ...
                    <div className="flex items-center justify-center gap-1">
                      <code className="text-xs text-[rgba(255,255,255,0.6)]">#5C3317</code>
                      <CopyButton text="#5C3317" onCopied={(text) => setToastMessage(`Copied ${text}`)} />
                    </div>
                  </div>
                  <div className="flex-1 space-y-2">
                    <motion.div 
                      ...
                      style={{ 
                        background: '#FFDAB9',
                        boxShadow: '0 4px 20px rgba(255, 218, 185, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                      }}
                    >
                    ...
                    <div className="flex items-center justify-center gap-1">
                      <code className="text-xs text-[rgba(255,255,255,0.6)]">#FFDAB9</code>
                      <CopyButton text="#FFDAB9" onCopied={(text) => setToastMessage(`Copied ${text}`)} />
                    </div>
                  </div>
                </div>
